...
# #
DRIVE_TRAIN_TYPE = "MM1" #"PWM_STEERING_THROTTLE"
# 
# #
...
MM1_SERIAL_PORT = '/dev/ttyAMA0' #'/dev/ttyS0'  # Serial Port for reading and sending MM1 data.
#MM1_SERIAL_PORT = '/dev/local0' #'/dev/ttyS0'  # Serial Port for reading and sending MM1 data.
# 
# #LOGGING
